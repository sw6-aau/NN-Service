...
curl -X POST "http://localhost:5000/storage/add/name=hello.txt&data=SGVsbG8gV29ybGQ="

echo -e "\n\e[38;5;4m-===TEST '/storage/get' (the created file)===-\n\e[0m"
curl -X GET "http://localhost:5000/storage/get/name=hello.txt"

echo -e "\n\e[38;5;4m-===TEST '/storage/get' (with mock.csv)===-\n\e[0m"
curl -X GET "http://localhost:5000/storage/get/name=mock.csv"
...
curl -X GET "http://localhost:5000/storage/get/name=../../service.py"
